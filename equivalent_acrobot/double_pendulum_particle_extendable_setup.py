...
des_com_ang_acc_x, des_com_ang_acc_y, des_com_ang_acc = symbols('cddot_x, cddot_y, thetaddot_c')
...
com_ddot_matrix = sympify('Matrix([\n[                                                           -(l_1*m_1*cos(theta1(t)) + l_1*m_2*cos(theta1(t)) + m_2*l_2(t)*cos(theta1(t) + theta2(t)))/(m_1 + m_2),                                                                                                                      -m_2*l_2(t)*cos(theta1(t) + theta2(t))/(m_1 + m_2), -m_2*sin(theta1(t) + theta2(t))/(m_1 + m_2)],\n[                                                           -(l_1*m_1*sin(theta1(t)) + l_1*m_2*sin(theta1(t)) + m_2*l_2(t)*sin(theta1(t) + theta2(t)))/(m_1 + m_2),                                                                                                                      -m_2*l_2(t)*sin(theta1(t) + theta2(t))/(m_1 + m_2),  m_2*cos(theta1(t) + theta2(t))/(m_1 + m_2)],\n[l_1*(l_1*m_1**2 + l_1*m_1*m_2*sin(theta2(t))**2 + l_1*m_1*m_2 + l_1*m_2**2*sin(theta2(t))**2 + m_1*m_2*l_2(t)*cos(theta2(t)))/(n_c*(m_1**2 + 2*m_1*m_2 + m_2**2)), -l_1*m_1*m_2*(l_1*m_1 + l_1*m_2 + m_2*l_2(t)*cos(theta2(t)))*l_2(t)**2/(n_c*(m_1 + m_2)**2*(l_1**2*m_1 + l_1**2*m_2 + 2*l_1*m_2*l_2(t)*cos(theta2(t)) + m_2*l_2(t)**2)),                                           0]])')
