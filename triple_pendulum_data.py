...
while x < 1.57:
  ...
  x = x + 0.01
"""
outputx = open('triple_pendulum_angle_one_lots.pkl', 'wb')
outputy = open('triple_pendulum_angle_two_lots.pkl', 'wb')
outputz = open('triple_pendulum_angle_three_lots.pkl', 'wb')
