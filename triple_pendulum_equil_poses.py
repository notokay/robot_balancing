...
for i in range(len(a1)):
  LH_x.append(left_leg*sin(a1[i]))
  LH_y.append(left_leg*cos(a1[i]))
  RH_x.append(left_leg*sin(a1[i]) + hip*sin(a2[i] + a1[i]))
  RH_y.append(left_leg*cos(a1[i]) + hip*cos(a2[i] + a1[i]))
  RA_x.append(left_leg*sin(a1[i]) + hip*sin(a2[i] + a1[i]) + right_leg*sin(a1[i]+a2[i]+a3[i]))
  RA_y.append(left_leg*cos(a1[i]) + hip*cos(a2[i] + a1[i]) + right_leg*cos(a1[i] + a2[i] + a3[i]))
